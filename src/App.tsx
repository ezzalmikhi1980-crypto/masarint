...
function Brand() {
  return <Link href="/" className="brand" data-testid="link-brand">
    <img src="/logo.png" alt="Masar International Logistics Company" className="brand-mark" />
...
function Contact({ lang }: { lang: Language }) {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    formData.append('access_key', 'e5656eb1-6ef1-4506-a2f5-0cdda0ebc106');
    formData.append('subject', `Masar logistics inquiry from ${formData.get('name')}`);
    formData.append('from_name', 'Masar International Logistics — Website');
    try {
