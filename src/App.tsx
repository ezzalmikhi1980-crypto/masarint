  ...
  return <footer className="footer">
    <div className="container-wide">
      <div className="footer-grid">
        ...
        <div><div className="footer-heading">{lang === 'en' ? 'Connect' : 'تواصل'}</div><a className="footer-link" href="mailto:ezzalmikhi1980@gmail.com" data-testid="link-footer-email">ezzalmikhi1980@gmail.com</a><span className="footer-text">{lang === 'en' ? 'Amman · Jordan · Global' : 'عمّان · الأردن · حول العالم'}</span></div>
...
function Contact({ lang }: { lang: Language }) {
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    window.location.href = `mailto:ezzalmikhi1980@gmail.com?subject=${subject}&body=${body}`;
    setSent(true);
  };
  return <main className="page-enter">
